...
namespace UnityStandardAssets.Cameras
{
    public class LookatTarget : AbstractTargetFollower
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            xAngle =                    Mathf.Clamp(xAngle, -m_RotationRange.x * 0.5f, 
                                                    m_RotationRange.x * 0.5f);
            ...
            m_FollowAngles =            Vector3.SmoothDamp(m_FollowAngles, targetAngles, 
                                                            ref m_FollowVelocity, m_FollowSpeed);


            // Und update the gameobject itself
            transform.localRotation =   m_OriginalRotation * Quaternion.Euler(-m_FollowAngles.x, 
                                                                                m_FollowAngles.y, 
                                                                                0);
        }
    }
